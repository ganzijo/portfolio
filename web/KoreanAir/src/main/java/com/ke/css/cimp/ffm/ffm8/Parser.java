...
public class Parser
{
         ...
         ParserException
  {
    ...
    else if (rulename.equalsIgnoreCase("Grp_Arrival_Information")) rule = Rule_Grp_Arrival_Information.parse(context);
    else if (rulename.equalsIgnoreCase("Grp_Departure_Information")) rule = Rule_Grp_Departure_Information.parse(context);
    ...
    else if (rulename.equalsIgnoreCase("TIME_OF_SCHEDULED_DEPARTURE")) rule = Rule_TIME_OF_SCHEDULED_DEPARTURE.parse(context);
