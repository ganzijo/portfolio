...
public class Parser
{
         ...
         ParserException
  {
    ...
    else if (rulename.equalsIgnoreCase("OCI_ISO_COUNTRY_CODE")) rule = Rule_OCI_ISO_COUNTRY_CODE.parse(context);
    else if (rulename.equalsIgnoreCase("OCI_INFORMATION_IDENTIFIER_1")) rule = Rule_OCI_INFORMATION_IDENTIFIER_1.parse(context);
    else if (rulename.equalsIgnoreCase("OCI_INFORMATION_IDENTIFIER_2")) rule = Rule_OCI_INFORMATION_IDENTIFIER_2.parse(context);
    else if (rulename.equalsIgnoreCase("OCI_INFORMATION")) rule = Rule_OCI_INFORMATION.parse(context);
