...
final public class Rule_SRI extends Rule
{
  public Rule_SRI(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_SRI parse(ParserContext context)
  {
    context.push("SRI");
    ...
    parsed = false;
    {
      ...
      if (parsed)
      {
        ...
        {
          Rule rule = Rule_MId_SRI.parse(context);
          if ((f1 = rule != null))
          {
              ...
              for (int i2 = 0; i2 < 1 && f2; i2++)
              {
                ...
                parsed = false;
                {
                  ...
                  if (parsed)
                  {
                    ...
                    {
                      Rule rule = Rule_SHIPMENT_REFERENCE_NUMBER.parse(context);
                      if ((f3 = rule != null))
                      {
                  ...
                  if (parsed)
                  {
                    ...
                    for (int i3 = 0; i3 < 1 && f3; i3++)
                    {
                      Rule rule = Rule_SHIPMENT_INFORMATION_1.parse(context);
                      if ((f3 = rule != null))
                      {
                        a3.add(rule, context.index);
                        c3++;
              ...
              for (int i2 = 0; i2 < 1 && f2; i2++)
              {
                ...
                parsed = false;
                {
                  ...
                  if (parsed)
                  {
                    ...
                    for (int i3 = 0; i3 < 1 && f3; i3++)
                    {
                      Rule rule = Rule_SHIPMENT_INFORMATION_2.parse(context);
                      if ((f3 = rule != null))
                      {
                        a3.add(rule, context.index);
                        c3++;
    ...
    if (parsed)
    {
        rule = new Rule_SRI(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("SRI", parsed);

    return (Rule_SRI)rule;
  }
}
