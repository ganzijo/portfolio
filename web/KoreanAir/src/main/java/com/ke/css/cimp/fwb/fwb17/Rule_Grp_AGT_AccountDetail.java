...
/* -----------------------------------------------------------------------------
 * Rule_Grp_AGT_AccountDetail.java
 * -----------------------------------------------------------------------------
 *
...
final public class Rule_Grp_AGT_AccountDetail extends Rule
{
  public Rule_Grp_AGT_AccountDetail(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_Grp_AGT_AccountDetail parse(ParserContext context)
  {
    context.push("Grp_AGT_AccountDetail");
    ...
    if (parsed)
    {
        rule = new Rule_Grp_AGT_AccountDetail(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("Grp_AGT_AccountDetail", parsed);

    return (Rule_Grp_AGT_AccountDetail)rule;
  }
}
