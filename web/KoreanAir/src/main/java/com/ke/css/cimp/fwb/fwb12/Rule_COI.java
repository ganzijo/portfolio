...
final public class Rule_COI extends Rule
{
  public Rule_COI(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_COI parse(ParserContext context)
  {
    context.push("COI");
    ...
    parsed = false;
    {
      ...
      if (parsed)
      {
        ...
        {
          Rule rule = Rule_MId_COI.parse(context);
          if ((f1 = rule != null))
          {
              ...
              for (int i2 = 0; i2 < 1 && f2; i2++)
              {
                ...
                parsed = false;
                {
                  ...
                  if (parsed)
                  {
                    ...
                    {
                      Rule rule = Rule_CASS_INDICATOR.parse(context);
                      if ((f3 = rule != null))
                      {
              ...
              for (int i2 = 0; i2 < 1 && f2; i2++)
              {
                ...
                parsed = false;
                {
                  ...
                  if (parsed)
                  {
                    ...
                    for (int i3 = 0; i3 < 1 && f3; i3++)
                    {
                      Rule rule = Rule_CASS_COMMISSION_AMOUNT.parse(context);
                      if ((f3 = rule != null))
                      {
                        a3.add(rule, context.index);
                        c3++;
              ...
              for (int i2 = 0; i2 < 1 && f2; i2++)
              {
                ...
                parsed = false;
                {
                  ...
                  if (parsed)
                  {
                    ...
                    for (int i3 = 0; i3 < 1 && f3; i3++)
                    {
                      Rule rule = Rule_CASS_COMMISSION_PERCENTAGE.parse(context);
                      if ((f3 = rule != null))
                      {
                        a3.add(rule, context.index);
                        c3++;
    ...
    if (parsed)
    {
        rule = new Rule_COI(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("COI", parsed);

    return (Rule_COI)rule;
  }
}
