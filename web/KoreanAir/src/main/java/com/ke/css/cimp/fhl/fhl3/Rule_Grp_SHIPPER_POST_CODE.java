...
/* -----------------------------------------------------------------------------
 * Rule_Grp_SHIPPER_POST_CODE.java
 * -----------------------------------------------------------------------------
 *
...
final public class Rule_Grp_SHIPPER_POST_CODE extends Rule
{
  public Rule_Grp_SHIPPER_POST_CODE(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_Grp_SHIPPER_POST_CODE parse(ParserContext context)
  {
    context.push("Grp_SHIPPER_POST_CODE");
    ...
    if (parsed)
    {
        rule = new Rule_Grp_SHIPPER_POST_CODE(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("Grp_SHIPPER_POST_CODE", parsed);

    return (Rule_Grp_SHIPPER_POST_CODE)rule;
  }
}
