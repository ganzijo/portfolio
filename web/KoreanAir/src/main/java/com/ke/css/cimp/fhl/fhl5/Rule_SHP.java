  ...
  public static Rule_SHP parse(ParserContext context)
  {
    ...
    parsed = false;
    {
      ...
      if (parsed)
      {
        ...
        for (int i1 = 0; i1 < 1 && f1; i1++)
        {
          Rule rule = Rule_Grp_SHIPPER_NAME.parse(context);
          if ((f1 = rule != null))
          {
            a1.add(rule, context.index);
            c1++;
      ...
      if (parsed)
      {
        ...
        for (int i1 = 0; i1 < 1 && f1; i1++)
        {
          Rule rule = Rule_Grp_SHIPPER_STREET_ADDRESS.parse(context);
          if ((f1 = rule != null))
          {
            a1.add(rule, context.index);
            c1++;
        ...
        for (int i1 = 0; i1 < 1 && f1; i1++)
        {
          ...
          parsed = false;
          {
            ...
            if (parsed)
            {
              ...
              {
                Rule rule = Rule_Grp_SHIPPER_STATE_PROVINCE.parse(context);
                if ((f2 = rule != null))
                {
        ...
        for (int i1 = 0; i1 < 1 && f1; i1++)
        {
          ...
          }
          {
            ...
            if (parsed)
            {
              ...
              for (int i2 = 0; i2 < 1 && f2; i2++)
              {
                Rule rule = Rule_Grp_SHIPPER_POST_CODE.parse(context);
                if ((f2 = rule != null))
                {
                  a2.add(rule, context.index);
                  c2++;
