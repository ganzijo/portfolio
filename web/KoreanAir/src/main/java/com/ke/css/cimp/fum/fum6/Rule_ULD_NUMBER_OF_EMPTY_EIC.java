...
/* -----------------------------------------------------------------------------
 * Rule_ULD_NUMBER_OF_EMPTY_EIC.java
 * -----------------------------------------------------------------------------
 *
...
final public class Rule_ULD_NUMBER_OF_EMPTY_EIC extends Rule
{
  public Rule_ULD_NUMBER_OF_EMPTY_EIC(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_ULD_NUMBER_OF_EMPTY_EIC parse(ParserContext context)
  {
    context.push("ULD_NUMBER_OF_EMPTY_EIC");
    ...
    if (parsed)
    {
        rule = new Rule_ULD_NUMBER_OF_EMPTY_EIC(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("ULD_NUMBER_OF_EMPTY_EIC", parsed);

    return (Rule_ULD_NUMBER_OF_EMPTY_EIC)rule;
  }
}
