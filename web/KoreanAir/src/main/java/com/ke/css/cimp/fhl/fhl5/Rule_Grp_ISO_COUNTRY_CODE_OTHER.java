...
/* -----------------------------------------------------------------------------
 * Rule_Grp_ISO_COUNTRY_CODE_OTHER.java
 * -----------------------------------------------------------------------------
 *
...
final public class Rule_Grp_ISO_COUNTRY_CODE_OTHER extends Rule
{
  public Rule_Grp_ISO_COUNTRY_CODE_OTHER(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_Grp_ISO_COUNTRY_CODE_OTHER parse(ParserContext context)
  {
    context.push("Grp_ISO_COUNTRY_CODE_OTHER");
        ...
        for (int i1 = 0; i1 < 1 && f1; i1++)
        {
          ...
          parsed = false;
          {
            ...
            if (parsed)
            {
              ...
              for (int i2 = 0; i2 < 1 && f2; i2++)
              {
                Rule rule = Rule_OCI_DESCRIPTION.parse(context);
                if ((f2 = rule != null))
                {
                  a2.add(rule, context.index);
                  c2++;
    ...
    if (parsed)
    {
        rule = new Rule_Grp_ISO_COUNTRY_CODE_OTHER(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("Grp_ISO_COUNTRY_CODE_OTHER", parsed);

    return (Rule_Grp_ISO_COUNTRY_CODE_OTHER)rule;
  }
}
