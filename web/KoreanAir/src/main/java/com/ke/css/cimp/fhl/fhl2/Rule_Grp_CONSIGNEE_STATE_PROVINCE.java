...
/* -----------------------------------------------------------------------------
 * Rule_Grp_CONSIGNEE_STATE_PROVINCE.java
 * -----------------------------------------------------------------------------
 *
...
final public class Rule_Grp_CONSIGNEE_STATE_PROVINCE extends Rule
{
  public Rule_Grp_CONSIGNEE_STATE_PROVINCE(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_Grp_CONSIGNEE_STATE_PROVINCE parse(ParserContext context)
  {
    context.push("Grp_CONSIGNEE_STATE_PROVINCE");
    ...
    if (parsed)
    {
        rule = new Rule_Grp_CONSIGNEE_STATE_PROVINCE(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("Grp_CONSIGNEE_STATE_PROVINCE", parsed);

    return (Rule_Grp_CONSIGNEE_STATE_PROVINCE)rule;
  }
}
