...
final public class Rule_ULD_CONTOUR_CODE extends Rule
{
  public Rule_ULD_CONTOUR_CODE(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_ULD_CONTOUR_CODE parse(ParserContext context)
  {
    context.push("ULD_CONTOUR_CODE");
    ...
    if (parsed)
    {
        rule = new Rule_ULD_CONTOUR_CODE(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("ULD_CONTOUR_CODE", parsed);

    return (Rule_ULD_CONTOUR_CODE)rule;
  }
}
