...
final public class Rule_Grp_ACD extends Rule
{
  public Rule_Grp_ACD(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_Grp_ACD parse(ParserContext context)
  {
    context.push("Grp_ACD");
              ...
              for (int i2 = 0; i2 < 1 && f2; i2++)
              {
                ...
                parsed = false;
                {
                  ...
                  if (parsed)
                  {
                    ...
                    {
                      Rule rule = Rule_Grp_ACD_1st.parse(context);
                      if ((f3 = rule != null))
                      {
              ...
              for (int i2 = 0; i2 < 1 && f2; i2++)
              {
                ...
                parsed = false;
                {
                  ...
                  if (parsed)
                  {
                    ...
                    for (int i3 = 0; i3 < 1 && f3; i3++)
                    {
                      Rule rule = Rule_Grp_ACD_2nd.parse(context);
                      if ((f3 = rule != null))
                      {
                        a3.add(rule, context.index);
                        c3++;
    ...
    if (parsed)
    {
        rule = new Rule_Grp_ACD(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("Grp_ACD", parsed);

    return (Rule_Grp_ACD)rule;
  }
}
