...
final public class Rule_ROUTING extends Rule
{
  public Rule_ROUTING(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_ROUTING parse(ParserContext context)
  {
              ...
              for (int i2 = 0; i2 < 1 && f2; i2++)
              {
                ...
                parsed = false;
                {
                  ...
                  if (parsed)
                  {
                    ...
                    {
                      Rule rule = Rule_Sub_Airport_City_Code.parse(context);
                      if ((f3 = rule != null))
                      {
    ...
    if (parsed)
    {
        rule = new Rule_ROUTING(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("ROUTING", parsed);

    return (Rule_ROUTING)rule;
  }
}
