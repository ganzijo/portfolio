...
final public class Rule_DST extends Rule
{
  public Rule_DST(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_DST parse(ParserContext context)
  {
    context.push("DST");
    ...
    parsed = false;
    {
      ...
      if (parsed)
      {
        ...
        {
          Rule rule = Rule_AIRPORT_CODE_OF_UNLOADING.parse(context);
          if ((f1 = rule != null))
          {
                    ...
                    for (int i3 = 0; i3 < 1 && f3; i3++)
                    {
                      ...
                      parsed = false;
                      {
                        ...
                        if (parsed)
                        {
                          ...
                          for (int i4 = 0; i4 < 1 && f4; i4++)
                          {
                            Rule rule = Rule_Grp_Arrival_Information.parse(context);
                            if ((f4 = rule != null))
                            {
                              a4.add(rule, context.index);
                              c4++;
                    ...
                    for (int i3 = 0; i3 < 1 && f3; i3++)
                    {
                      ...
                      parsed = false;
                      {
                        ...
                        if (parsed)
                        {
                          ...
                          for (int i4 = 0; i4 < 1 && f4; i4++)
                          {
                            Rule rule = Rule_Grp_Departure_Information.parse(context);
                            if ((f4 = rule != null))
                            {
                              a4.add(rule, context.index);
                              c4++;
    ...
    if (parsed)
    {
        rule = new Rule_DST(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("DST", parsed);

    return (Rule_DST)rule;
  }
}
