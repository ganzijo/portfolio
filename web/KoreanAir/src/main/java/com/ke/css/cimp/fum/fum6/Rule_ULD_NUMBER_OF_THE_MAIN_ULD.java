...
/* -----------------------------------------------------------------------------
 * Rule_ULD_NUMBER_OF_THE_MAIN_ULD.java
 * -----------------------------------------------------------------------------
 *
...
final public class Rule_ULD_NUMBER_OF_THE_MAIN_ULD extends Rule
{
  public Rule_ULD_NUMBER_OF_THE_MAIN_ULD(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_ULD_NUMBER_OF_THE_MAIN_ULD parse(ParserContext context)
  {
    context.push("ULD_NUMBER_OF_THE_MAIN_ULD");
    ...
    if (parsed)
    {
        rule = new Rule_ULD_NUMBER_OF_THE_MAIN_ULD(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("ULD_NUMBER_OF_THE_MAIN_ULD", parsed);

    return (Rule_ULD_NUMBER_OF_THE_MAIN_ULD)rule;
  }
}
