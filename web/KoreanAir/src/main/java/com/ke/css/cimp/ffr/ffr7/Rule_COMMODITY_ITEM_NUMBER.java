...
/* -----------------------------------------------------------------------------
 * Rule_COMMODITY_ITEM_NUMBER.java
 * -----------------------------------------------------------------------------
 *
...
final public class Rule_COMMODITY_ITEM_NUMBER extends Rule
{
  public Rule_COMMODITY_ITEM_NUMBER(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_COMMODITY_ITEM_NUMBER parse(ParserContext context)
  {
    context.push("COMMODITY_ITEM_NUMBER");
    ...
    if (parsed)
    {
        rule = new Rule_COMMODITY_ITEM_NUMBER(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("COMMODITY_ITEM_NUMBER", parsed);

    return (Rule_COMMODITY_ITEM_NUMBER)rule;
  }
}
