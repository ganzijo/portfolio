...
final public class Rule_UMI extends Rule
{
  public Rule_UMI(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_UMI parse(ParserContext context)
  {
    context.push("UMI");
        ...
        for (int i1 = 0; i1 < 1 && f1; i1++)
        {
          ...
          parsed = false;
          {
            ...
            if (parsed)
            {
              ...
              {
                Rule rule = Rule_UMIS.parse(context);
                if ((f2 = rule != null))
                {
                    ...
                    for (int i3 = 0; i3 < 1 && f3; i3++)
                    {
                      ...
                      parsed = false;
                      {
                        ...
                        if (parsed)
                        {
                          ...
                          {
                            Rule rule = Rule_Grp_ULD_Utilisation_Detail.parse(context);
                            if ((f4 = rule != null))
                            {
    ...
    if (parsed)
    {
        rule = new Rule_UMI(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("UMI", parsed);

    return (Rule_UMI)rule;
  }
}
