...
/* -----------------------------------------------------------------------------
 * Rule_Grp_Coded_Location_CNE.java
 * -----------------------------------------------------------------------------
 *
...
final public class Rule_Grp_Coded_Location_CNE extends Rule
{
  public Rule_Grp_Coded_Location_CNE(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_Grp_Coded_Location_CNE parse(ParserContext context)
  {
    context.push("Grp_Coded_Location_CNE");
                    ...
                    for (int i3 = 0; i3 < 1 && f3; i3++)
                    {
                      ...
                      parsed = false;
                      {
                        ...
                        if (parsed)
                        {
                          ...
                          for (int i4 = 0; i4 < 1 && f4; i4++)
                          {
                            Rule rule = Rule_CONSIGNEE_POST_CODE.parse(context);
                            if ((f4 = rule != null))
                            {
                              a4.add(rule, context.index);
                              c4++;
    ...
    if (parsed)
    {
        rule = new Rule_Grp_Coded_Location_CNE(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("Grp_Coded_Location_CNE", parsed);

    return (Rule_Grp_Coded_Location_CNE)rule;
  }
}
