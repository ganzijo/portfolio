...
/* -----------------------------------------------------------------------------
 * Rule_Grp_Coded_Location_NFY.java
 * -----------------------------------------------------------------------------
 *
...
final public class Rule_Grp_Coded_Location_NFY extends Rule
{
  public Rule_Grp_Coded_Location_NFY(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_Grp_Coded_Location_NFY parse(ParserContext context)
  {
    context.push("Grp_Coded_Location_NFY");
        ...
        for (int i1 = 0; i1 < 1 && f1; i1++)
        {
          ...
          parsed = false;
          {
            ...
            if (parsed)
            {
              ...
              for (int i2 = 0; i2 < 1 && f2; i2++)
              {
                Rule rule = Rule_NOTIFY_ISO_COUNTRY_CODE.parse(context);
                if ((f2 = rule != null))
                {
                  a2.add(rule, context.index);
                  c2++;
                    ...
                    for (int i3 = 0; i3 < 1 && f3; i3++)
                    {
                      ...
                      parsed = false;
                      {
                        ...
                        if (parsed)
                        {
                          ...
                          for (int i4 = 0; i4 < 1 && f4; i4++)
                          {
                            Rule rule = Rule_NOTIFY_POST_CODE.parse(context);
                            if ((f4 = rule != null))
                            {
                              a4.add(rule, context.index);
                              c4++;
                        ...
                        if (parsed)
                        {
                          ...
                          for (int i4 = 0; i4 < 1 && f4; i4++)
                          {
                            Rule rule = Rule_NOTIFY_CONTACT.parse(context);
                            if ((f4 = rule != null))
                            {
                              a4.add(rule, context.index);
                              c4++;
    ...
    if (parsed)
    {
        rule = new Rule_Grp_Coded_Location_NFY(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("Grp_Coded_Location_NFY", parsed);

    return (Rule_Grp_Coded_Location_NFY)rule;
  }
}
