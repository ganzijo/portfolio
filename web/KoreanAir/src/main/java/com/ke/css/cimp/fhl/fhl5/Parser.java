...
public class Parser
{
         ...
         ParserException
  {
    ...
    else if (rulename.equalsIgnoreCase("Grp_ISO_COUNTRY_CODE_KR")) rule = Rule_Grp_ISO_COUNTRY_CODE_KR.parse(context);
    else if (rulename.equalsIgnoreCase("Grp_EXPIMP_IDENTIFIER")) rule = Rule_Grp_EXPIMP_IDENTIFIER.parse(context);
    else if (rulename.equalsIgnoreCase("Grp_KR_EXP")) rule = Rule_Grp_KR_EXP.parse(context);
    else if (rulename.equalsIgnoreCase("Grp_KR_IMP")) rule = Rule_Grp_KR_IMP.parse(context);
    else if (rulename.equalsIgnoreCase("Grp_ISO_COUNTRY_CODE_OTHER")) rule = Rule_Grp_ISO_COUNTRY_CODE_OTHER.parse(context);
    else if (rulename.equalsIgnoreCase("SHP")) rule = Rule_SHP.parse(context);
    else if (rulename.equalsIgnoreCase("Grp_SHIPPER_NAME")) rule = Rule_Grp_SHIPPER_NAME.parse(context);
    else if (rulename.equalsIgnoreCase("Grp_SHIPPER_STREET_ADDRESS")) rule = Rule_Grp_SHIPPER_STREET_ADDRESS.parse(context);
    ...
    else if (rulename.equalsIgnoreCase("Grp_CONSIGNEE_NAME")) rule = Rule_Grp_CONSIGNEE_NAME.parse(context);
    else if (rulename.equalsIgnoreCase("Grp_CONSIGNEE_STREET_ADDRESS")) rule = Rule_Grp_CONSIGNEE_STREET_ADDRESS.parse(context);
    ...
    else if (rulename.equalsIgnoreCase("MId_HTS")) rule = Rule_MId_HTS.parse(context);
    ...
    else if (rulename.equalsIgnoreCase("TRANSPORT_IDENTIFIER")) rule = Rule_TRANSPORT_IDENTIFIER.parse(context);
    else if (rulename.equalsIgnoreCase("HSN_NUMBER")) rule = Rule_HSN_NUMBER.parse(context);
    else if (rulename.equalsIgnoreCase("EPN_NUMBER")) rule = Rule_EPN_NUMBER.parse(context);
    else if (rulename.equalsIgnoreCase("EXP_PACKING_CODE")) rule = Rule_EXP_PACKING_CODE.parse(context);
    else if (rulename.equalsIgnoreCase("EXP_NUMBER_OF_PIECES")) rule = Rule_EXP_NUMBER_OF_PIECES.parse(context);
    else if (rulename.equalsIgnoreCase("EXP_PACKING_TYPE")) rule = Rule_EXP_PACKING_TYPE.parse(context);
    else if (rulename.equalsIgnoreCase("EPN_SEQ")) rule = Rule_EPN_SEQ.parse(context);
    else if (rulename.equalsIgnoreCase("EPN_NUMBER_OF_PIECES")) rule = Rule_EPN_NUMBER_OF_PIECES.parse(context);
    else if (rulename.equalsIgnoreCase("EPN_WEIGHT")) rule = Rule_EPN_WEIGHT.parse(context);
    else if (rulename.equalsIgnoreCase("EPN_DIVISION_IDENTIFIER")) rule = Rule_EPN_DIVISION_IDENTIFIER.parse(context);
    else if (rulename.equalsIgnoreCase("EPN_DIVISION_DIMENSION")) rule = Rule_EPN_DIVISION_DIMENSION.parse(context);
    else if (rulename.equalsIgnoreCase("LOAD_COMMODITY_CODE")) rule = Rule_LOAD_COMMODITY_CODE.parse(context);
    else if (rulename.equalsIgnoreCase("SYSTEM_IDENTIFIER")) rule = Rule_SYSTEM_IDENTIFIER.parse(context);
    else if (rulename.equalsIgnoreCase("OCI_DESCRIPTION")) rule = Rule_OCI_DESCRIPTION.parse(context);
