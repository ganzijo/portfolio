...
final public class Rule_AGT extends Rule
{
  public Rule_AGT(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_AGT parse(ParserContext context)
  {
    context.push("AGT");
    ...
    parsed = false;
    {
      ...
      if (parsed)
      {
        ...
        {
          Rule rule = Rule_MId_AGT.parse(context);
          if ((f1 = rule != null))
          {
                    ...
                    for (int i3 = 0; i3 < 1 && f3; i3++)
                    {
                      ...
                      parsed = false;
                      {
                        ...
                        if (parsed)
                        {
                          ...
                          {
                            Rule rule = Rule_Grp_AGT_AccountDetail.parse(context);
                            if ((f4 = rule != null))
                            {
      ...
      if (parsed)
      {
        ...
        for (int i1 = 0; i1 < 1 && f1; i1++)
        {
          Rule rule = Rule_AGENT_NAME.parse(context);
          if ((f1 = rule != null))
          {
            a1.add(rule, context.index);
            c1++;
      ...
      if (parsed)
      {
        ...
        for (int i1 = 0; i1 < 1 && f1; i1++)
        {
          Rule rule = Rule_AGENT_PLACE.parse(context);
          if ((f1 = rule != null))
          {
            a1.add(rule, context.index);
            c1++;
    ...
    if (parsed)
    {
        rule = new Rule_AGT(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("AGT", parsed);

    return (Rule_AGT)rule;
  }
}
