...
/* -----------------------------------------------------------------------------
 * Rule_Grp_Account_Detail_CUS.java
 * -----------------------------------------------------------------------------
 *
...
final public class Rule_Grp_Account_Detail_CUS extends Rule
{
  public Rule_Grp_Account_Detail_CUS(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_Grp_Account_Detail_CUS parse(ParserContext context)
  {
    context.push("Grp_Account_Detail_CUS");
                    ...
                    for (int i3 = 0; i3 < 1 && f3; i3++)
                    {
                      ...
                      parsed = false;
                      {
                        ...
                        if (parsed)
                        {
                          ...
                          {
                            Rule rule = Rule_AGENT_ACCOUNT_NUMBER.parse(context);
                            if ((f4 = rule != null))
                            {
                    ...
                    for (int i3 = 0; i3 < 1 && f3; i3++)
                    {
                      ...
                      parsed = false;
                      {
                        ...
                        if (parsed)
                        {
                          ...
                          for (int i4 = 0; i4 < 1 && f4; i4++)
                          {
                            Rule rule = Rule_IATA_CARGO_AGENT_CODE.parse(context);
                            if ((f4 = rule != null))
                            {
                              a4.add(rule, context.index);
                              c4++;
                    ...
                    for (int i3 = 0; i3 < 1 && f3; i3++)
                    {
                      ...
                      parsed = false;
                      {
                        ...
                        if (parsed)
                        {
                          ...
                          for (int i4 = 0; i4 < 1 && f4; i4++)
                          {
                            Rule rule = Rule_AGENT_PARTICIPANT_IDENTIFIER.parse(context);
                            if ((f4 = rule != null))
                            {
                              a4.add(rule, context.index);
                              c4++;
    ...
    if (parsed)
    {
        rule = new Rule_Grp_Account_Detail_CUS(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("Grp_Account_Detail_CUS", parsed);

    return (Rule_Grp_Account_Detail_CUS)rule;
  }
}
