...
final public class Rule_Typ_ErrorMsg extends Rule
{
  public Rule_Typ_ErrorMsg(String spelling, ArrayList<Rule> rules)
  {
  ...
  public static Rule_Typ_ErrorMsg parse(ParserContext context)
  {
    context.push("Typ_ErrorMsg");
    ...
    if (parsed)
    {
        rule = new Rule_Typ_ErrorMsg(context.text.substring(a0.start, a0.end), a0.rules);
    }
    else
    {
        context.index = s0;
    ...
    context.pop("Typ_ErrorMsg", parsed);

    return (Rule_Typ_ErrorMsg)rule;
  }
}
