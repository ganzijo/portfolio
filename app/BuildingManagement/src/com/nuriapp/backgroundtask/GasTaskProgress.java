...
public class GasTaskProgress extends AsyncTask<Cursor, Void, BenchAdapter> {
	...
	protected void onPostExecute(BenchAdapter result) {
		...
		ListView benchListView = (ListView) DetailGas.context
