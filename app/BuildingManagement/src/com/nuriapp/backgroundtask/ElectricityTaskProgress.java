...
import com.nuriapp.activity.DetailElectricity;
import com.nuriapp.activity.DetailInfo;
import com.nuriapp.adapter.BenchAdapter;
import com.nuriapp.data.BenchData;

public class ElectricityTaskProgress extends
		AsyncTask<Cursor, Void, BenchAdapter> {
	...
	protected void onPostExecute(BenchAdapter result) {
		...
		ListView benchListView = (ListView) DetailElectricity.context
				.findViewById(R.id.BenchList);
