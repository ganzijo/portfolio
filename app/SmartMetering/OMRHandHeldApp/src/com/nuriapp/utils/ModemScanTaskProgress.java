...
public class ModemScanTaskProgress extends AsyncTask<Integer, String, Integer> {
	// ProgressDialog를 멤버로 하나 넣어줌
	private ProgressDialog mDlg;
	private Context mContext;
	

	public ModemScanTaskProgress(Context readListFragment) {
