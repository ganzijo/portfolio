...
public class CrcVO {
	static short[] CrcTable = {	//polynominal : (short)0x1021
	...
	// struct
	kmp_head_t KMP_HEAD_t ;
	kmp_frame_t KMP_FRAME_t ;
	kmp_tail_t KMP_TAIL_t ;
	...
	char KMP_EOF = 0x0d;
	char KMP_ACK = 0x06;
	char KMP_FLAG_END = 0x07;
	
	// constructor
	public CrcVO(){
		KMP_HEAD_t  = new kmp_head_t();		
		KMP_FRAME_t  = new kmp_frame_t();
		KMP_FRAME_t.hdr = KMP_HEAD_t;
		KMP_TAIL_t  = new kmp_tail_t();
	}
}

class kmp_head_t{
	byte start;		// SOF(0x80,0x40)
	byte address;
	byte cid;
}
